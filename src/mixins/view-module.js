...
export default {
  data () {
    ...
    return {
      ...
      setDataPermissionVisible:false//数据授权窗口 By 胡托
    }
    /* eslint-enable */
  },
  created () {
  ...
  methods: {
    ...
    // 新增 / 修改
    setDataPermission (id) {
      this.setDataPermissionVisible = true
      this.$nextTick(() => {
        this.$refs.setDataPermission.dataForm.userid = id
        this.$refs.setDataPermission.init()
      })
    },
    // 关闭当前窗口
