    ...
    <form-list
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" :rules="rules" :inline="true" label-width="180px">
                <el-form-item label="合作方法人全称" prop="hzfmc">
                    <el-input class="form-inline-input" v-model="form.hzfmc"></el-input>
                </el-form-item>
            </el-form>
            <el-divider></el-divider>
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogVisible = false">取 消</el-button>
                <el-button type="primary" @click="saveHzfqy">确 定</el-button>
            </span>
        </el-dialog>
  </div>
</template>
...
export default {
    ...
    data() {
      return {
        ...
        searchList: [
            {index: 0,key: "hzfmc",val: "",type: "autocomplete",label: "搜索",placeholder: "合作方法人全称"},
            {key: "bz",val: "",type: "select",
                options: [
                    {value:"",label:"全部"},
                    {value:"1",label:"启用"},
                    {value:"0",label:"停用"},
          ...
          rules: {
              hzfmc: [
                  { required: true, message: '请输入合作方法人全称', trigger: 'blur' },
