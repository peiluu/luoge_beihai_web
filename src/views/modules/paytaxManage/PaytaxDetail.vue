    ...
    <div class="custom-content">
        <div style="display: flex;">
            <div class="mid-margin-40 custom-content-title" style="width: 100%;">
                ...
                <div class="custom-content-title-date">{{payPeriod.substring(0,4)+'年'+payPeriod.substring(4,6)+'月'}}</div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            handleBack(){
                this.$router.push({path: "/paytaxManage-PaytaxList"})
            },
            ...
            fetchTableData(id){
                let that = this;
                that.business.customPost(that.request_host+"/ComprehensiveIncome/getPaytaxDetail/"+this.$store.state.user.payPeriod,
                    {'Content-Type': 'application/json; charset=utf-8',"Data-Type":"json"},
