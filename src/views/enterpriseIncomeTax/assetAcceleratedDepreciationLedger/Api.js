...
// 获取列表
export const getList = (data) => postJSON(`${config.host}/ledgerSdsZcjszjtx/page`, data);
 ...
 * @desption 删除
 */
export const del = (id) => deleteOne(`${config.host}/ledgerSdsZcjszjtx/delete/${id}`, id);

/**
 * @desption 新增
 */
export const add = (data) => postJSON(`${config.host}/ledgerSdsZcjszjtx/add`, data);
/**
 * @desption 编辑
 */
export const update = (data) => postJSON(`${config.host}/ledgerSdsZcjszjtx/update`, data);
