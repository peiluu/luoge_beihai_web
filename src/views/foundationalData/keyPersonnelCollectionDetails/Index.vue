<template>
  <div class="main-content" :style="'height: ' + contentHeight + 'px;'">
    <form-list :columns="columns" :searchKey="propsKey" :searchRow="searchList" :api="api" :param="param" :height="height" @handleSelection="handleSelection" v-loading="loading" :tableCounterShow="true" ref="list"
      @getNextList="getNextList" @getSearchParam="getSearchParam" :firstLoading="false">
      <!-- 操作按钮 -->
...
export default {
  ...
  methods: {
    ...
    //导入
    handleImport() {
      sessionStorage.setItem('clearKeyPersonnelImport', 1)
      this.$router.push({ path: "/keyPersonnelCollectionDetails/keyPersonnelImport" })
      this.$store.dispatch('app/removeTab', this.$store.getters.activeTab);
    },
