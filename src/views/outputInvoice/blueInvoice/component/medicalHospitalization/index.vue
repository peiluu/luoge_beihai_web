<template>
    <div class="">
      <el-form ref="medicalClinicFormRef" :model="form" :rules="rules">
        ...
        <el-form-item label="病历号" >
          <el-input v-model="form.blh" placeholder="请输入病历号"></el-input>
        </el-form-item>
        <el-form-item label="住院号" prop="zyh">
          <el-input v-model="form.zyh" placeholder="请输入住院号"></el-input>
        </el-form-item>
        <el-form-item label="住院科别" prop="zykb">
          <el-input v-model="form.zykb" placeholder="请输入住院科别"></el-input>
        </el-form-item>
        <el-form-item label="住院时间起" >
          <el-date-picker
            v-model="form.zysjq"
        ...
        <el-form-item label="预缴金额" >
          <el-input v-model="form.mzh" placeholder="请输入预缴金额"></el-input>
        </el-form-item>
        <el-form-item label="补缴金额" >
          <el-input v-model="form.mzh" placeholder="请输入补缴金额"></el-input>
        </el-form-item>
  ...
  export default {
    name: "medicalHospitalizationPage",
    components: {},
    props: {
      dataSource:{
          type:Object,
