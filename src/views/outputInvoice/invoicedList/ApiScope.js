...
export const getList = (data) =>
  postJSON(`/invoiceUpload/successfulInvoice`, { ...data, scope: '1' });
...
export const downLoadPdf = (data) =>
  download('/invoiceUpload/downLoadPdf', data);
...
export const sendPdf = (data) =>
  postJSON('/invoiceUpload/sendPdf', data, null, true);
...
export const updateInvoiceOrgId = (data) =>
  postJSON('/invoiceUpload/updateInvoiceOrgId', data);

/**
 * @desption 导出
 */
export const downLoadInvoiceList = (data) =>
  download('/invoiceUpload/downLoadList', data);
/**
 * @desption 获取区域选择下拉
 */
