...
export const getList = (data) =>
  postJSON(`${config.host}/invoiceUpload/successfulInvoice`, { ...data, scope: '1' });
...
export const downLoadPdf = (data) =>
  download(`${config.host}/invoiceUpload/downLoadPdf`, data);
 ...
 * @desption 发送pdf
 */
export const sendPdf = (data) =>
  postJSON(`${config.host}/invoiceUpload/sendPdf`, data, null, true);
 ...
 * @desption 更新发票orgid
 */
export const updateInvoiceOrgId = (data) =>
  postJSON(`${config.host}/invoiceUpload/updateInvoiceOrgId`, data);

/**
 * @desption 导出
 */
export const downLoadInvoiceList = (data) =>
  download(`${config.host}/invoiceUpload/downLoadList`, data);
/**
 * @desption 获取区域选择下拉
 */
